...
@Client.on_message(filters.command(["yta","audio","ytm"], prefix))
...
@Client.on_message(filters.command(["ytv","video"], prefix))
...
@Client.on_message(filters.command(["ytvl","lowyt"], prefix))
...
modules_help["youtube"] = {
    "yta [query or YouTube link]": "Download audio (mp3) from YouTube or a direct YouTube link.",
    "ytv [query or YouTube link]": "Download high quality video (720p) from YouTube or a direct YouTube link.",
    "ytvl [query or YouTube link]": "Download low quality video (360p) from YouTube or a direct YouTube link.",
}
